    ...
    <script>
        $(document).ready(function() {
            ...
            function updateTime() {
                ...
                // Format the time
                const formattedTime =
                    `${hours}:${minutes < 10 ? '0' : ''}${minutes}:${seconds < 10 ? '0' : ''}${seconds} ${ampm}`;
            ...
            $('.adduser2').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.fields.first_name) {
                            $('.error-fname').show()
                        } else {
                            $('.error-fname').hide()
                        }
                        if (res.fields.last_name) {
                            $('.error-lname').show()
                        } else {
                            $('.error-lname').hide()
                        }
                        if (res.fields.username) {
                            $('.error-username').show()
                        } else {
                            $('.error-username').hide()
                        }
                        ...
                        if (res.fields.password) {
                            $('.error-password').show()
                            $('.error-cpassword').show()
                        } else {
                            $('.error-password').hide()
                            $('.error-cpassword').hide()
                        }
