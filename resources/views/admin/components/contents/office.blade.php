                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data, type, row){
                            ...
                            var renderAction = `
                            <a href="{{ route('administrator.dashboard.offices.user', ['office_id' => '']) }}/${officeId}" id="view-users-btn" class="ri-user-add-line text-white font-size-18 btn btn-success p-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Assigned Users"></a>
