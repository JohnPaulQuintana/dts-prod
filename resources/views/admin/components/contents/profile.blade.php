                ...
                <div class="container">
                    <div class="row gx-4 gy-6">
                        <div class="col-12 col-sm-6 mb-3">
                            <div class="p-4 bg-white shadow rounded-lg">
                                <div class="max-w-xl">
                                    @include('admin.components.profile.partials.update-profile-information-form')
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6 mb-3">
                            <div class="p-4 bg-white shadow rounded-lg">
                                <div class="max-w-xl">
                                    @include('admin.components.profile.partials.update-password-form')
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-4 bg-white shadow rounded-lg">
                                <div class="max-w-xl">
                                    @include('admin.components.profile.partials.delete-user-form')
                                </div>
                            </div>
                        </div>
                    </div>
